...
def Evaluate_Ranking(Direct_llista,train_or_val): #Funció declarada passant com a paràmetres 
    ...
    #A continuació crearem els 4 fitxers de sortida corresponents. Més endavant anirem depurant questa part per fer-ho amb els mínims i necessaris
    ...
    for line in Direct_llista:
        ...
        if train_or_val == "train":
            ...
            APv = label_ranking_average_precision_score(Direct_llista,fitxer_anot2)
...
Evaluate_Ranking("features_valid.txt","val")
